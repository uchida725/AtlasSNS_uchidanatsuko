...
<a href="{{ url('/profile_users',$following_user->id )}}">
...
<div><a href="{{ url('/profile_users',$post->user->id) }}"><img src="{{ asset('storage/'.$post->user->icon_image) }}" class="" width="50" height="50"></a>
